 ...
 */
function Qiwi(token, proxy) {
console.log(proxy)
if(proxy) request = request.defaults({'proxy': proxy});

request = request.defaults({timeout: 60000})
...
//https://edge.qiwi.com/payment-history/v1/transactions/transactionId/cheque/file?type=value&format=value
    this.getCheck = function (id, callback) {
        var options = {
            url: this.apiUri + '/payment-history/v1/transactions/' + id + '/cheque/file?type=OUT&format=JPEG',
